...
ALL_DATA_TOOLS = ("github", "gravatar", "wayback", "whatsmyname", "openalex", "perplexity", "exa", "firecrawl")
...
TOOL_PRICES: dict[str, float] = {
    ...
    "github_intel": 0.0, "gravatar_lookup": 0.0, "wayback_lookup": 0.0, "whatsmyname": 0.0, "openalex_lookup": 0.0,
}
